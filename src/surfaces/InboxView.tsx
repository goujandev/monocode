...
export function InboxView({
  ...
  // Read on mount and whenever a token changes. The two reads are independent:
  // a failing Linear check must not discard the GitLab answer, so each provider
  // keeps its previous value on its own.
  useEffect(() => {
    let cancelled = false;
    const read = () => {
