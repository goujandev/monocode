import { INBOX_SOURCE_LABELS, type InboxSource } from "../lib/inboxFilters";
import { InboxProviderMark } from "./InboxProviderMark";
import { Popover, type PopoverAnchor } from "./Popover";

export const INBOX_CONNECT_MENU_WIDTH = 188;
...
export function InboxConnectMenu({
  ...
  sources: InboxSource[];
  onConnect: (source: InboxSource) => void;
  onClose: () => void;
}) {
  return (
    <Popover
      anchor={anchor}
      gap={4}
      width={INBOX_CONNECT_MENU_WIDTH}
      onDismiss={onClose}
      role="menu"
